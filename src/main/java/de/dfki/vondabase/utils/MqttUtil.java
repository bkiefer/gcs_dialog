...
public class MqttUtil {
  ...
  private Queue<byte []> message_queue = new LinkedList<byte []>();
  ...
  public MqttUtil(Map<String, Object> config) throws MqttException {
  ...
  public void register(String topic) throws MqttException {
