 ...
 *
 * Triggers the third phase of the GCS computation, i.e. the dialogue where we assess the motoric capabilities of a user.,
 ...
 *
 */
public class GCSPhaseThreeHandler extends AbstractHandler {
    ...
    public GCSPhaseThreeHandler(BaseCommunicationHub hub) {
        super();
    ...
    protected void handlePostRequest(HttpExchange exchange) throws IOException {
        ...
        try {
            GCSService service = new GCSService(_agent, jsonObject.getInt("body_id"), 3);
