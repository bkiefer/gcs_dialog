 ...
 *
 * Triggers the second phase of the GCS computation, i.e. the dialogue where we assess the users orientation,
 ...
 *
 */
public class GCSPhaseTwoHandler extends AbstractHandler {
    ...
    public GCSPhaseTwoHandler(BaseCommunicationHub hub) {
        super();
    ...
    protected void handlePostRequest(HttpExchange exchange) throws IOException {
        ...
        try {
            GCSService service = new GCSService(_agent, jsonObject.getInt("body_id"), 2);
