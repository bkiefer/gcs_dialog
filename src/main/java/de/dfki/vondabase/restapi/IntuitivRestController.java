...
public class IntuitivRestController {
  ...
  public void initEndpoints(){
    ...
    GCSPhaseOneHandler gcsPhaseOneHandler = new GCSPhaseOneHandler(hub);
    _server.createContext("/dialog/gcs_1", gcsPhaseOneHandler);
    GCSPhaseTwoHandler gcsPhaseTwoHandler = new GCSPhaseTwoHandler(hub);
    _server.createContext("/dialog/gcs_2", gcsPhaseTwoHandler);
    GCSPhaseThreeHandler gcsPhaseThreeHandler = new GCSPhaseThreeHandler(hub);
    _server.createContext("/dialog/gcs_3", gcsPhaseThreeHandler);
    ...
    PainHandler painHandler = new PainHandler(hub);
    _server.createContext("/dialog/pain",painHandler);
